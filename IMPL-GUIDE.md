...
* When you receive an `OrderModified` notice, use the order ID to modifiy the described order in your view. Note that the modified order could change the price and the quantity but it can not cross bid and ask. 
