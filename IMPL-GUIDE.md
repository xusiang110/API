...
* When you receive an `OrderModified` notice, modify the described order to your view by order ID. Note that the modified order could changes the price and the quantity but it can not cross bid and ask. 
